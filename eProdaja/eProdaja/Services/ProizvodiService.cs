...
{
    public class ProizvodiService : BaseCRUDService<Model.Proizvodi, ProizvodiSearchRequest, ProizvodiInsertRequest, ProizvodiUpdateRequest, Database.Proizvodi>, IProizvodiService
    {
